...
namespace BugTracker.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProjectId,TicketId,Title,Message,DateCreated,SenderId,RecipientId,NotificationTypeId,HasBeenViewed")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProjectId,TicketId,Title,Message,DateCreated,SenderId,RecipientId,NotificationTypeId,HasBeenViewed")] Notification notification)
        {
