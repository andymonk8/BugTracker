...
namespace BugTracker.Controllers
{
    public class TicketCommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Comment,DateCreated,TicketId,UserId")] TicketComment ticketComment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Comment,DateCreated,TicketId,UserId")] TicketComment ticketComment)
        {
