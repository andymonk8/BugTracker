...
namespace BugTracker.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,DateCreated,TicketId,UserId,FileName,FileData,FileType")] TicketAttachment ticketAttachment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description,DateCreated,TicketId,UserId,FileName,FileData,FileType")] TicketAttachment ticketAttachment)
        {
